...
class DSRnet(nn.Module):
    ...
    def forward(self,image,lr):
        ...
        #print(iconv4.size())
        output_disp4 = self.disp4(iconv4)# + lr_pyramid[3]
        ...
        output_disp3 = self.disp3(torch.cat((iconv3,up_disp4),1))# + lr_pyramid[2]
        ...
        output_disp2 = self.disp2(torch.cat((iconv2,up_disp3),1))# + lr_pyramid[1]
        ...
        output_disp1 = self.disp1(torch.cat((iconv1,up_disp2),1))# + lr_pyramid[0]
