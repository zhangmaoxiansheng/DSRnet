...
class DSRnet(nn.Module):
    ...
    def __init__(self, max_disp):
        ...
        self.disp4 = get_disp_conv(128)
        
        self.up3 = upconv(384, 64)#256+128=384 H/4
        self.disp3 = get_disp_conv(64)
        
        self.up2 = upconv(128,32)#64+64=128 H/2
        self.disp2 = get_disp_conv(32)
        
        self.up1 = upconv(96,32)#64+32=96 H/2
        self.disp1 = get_disp_conv(32)
    ...
    def forward(self,image,lr):
        ...
        #print(iconv4.size())
        output_disp4 = self.disp4(iconv4, lr_pyramid[3], lr_pyramid[3], self.max_disp)# + lr_pyramid[3]
        ...
        output_disp3 = self.disp3(iconv3, up_disp4, lr_pyramid[2], self.max_disp)# + lr_pyramid[2]
        ...
        output_disp2 = self.disp2(iconv2, up_disp3, lr_pyramid[1], self.max_disp)# + lr_pyramid[1]
        ...
        output_disp1 = self.disp1(iconv1, up_disp2, lr_pyramid[0], self.max_disp)# + lr_pyramid[0]
